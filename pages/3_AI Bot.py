...
def main():
    ...
    st.header("Ask questions about the election")
    st.write("(This AI-powered chatbot can provide immediate answers to questions about candidates, their manifestos, and election details.)")
